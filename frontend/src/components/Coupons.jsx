...
function Coupons() {
    ...
    if (loading) {
        return (
            <div className="mt-10 flex flex-col items-center justify-center text-[var(--color-dark-green-half)]">
                <div className="w-full max-w-xl animate-pulse space-y-4">
                    <div className="h-16 rounded-2xl bg-[var(--color-lighter-green)]" />
                    <div className="h-16 rounded-2xl bg-[var(--color-lighter-green)]" />
                    <div className="h-16 rounded-2xl bg-[var(--color-lighter-green)]" />
                </div>
        ...
        return (
            <div className="mt-10 flex flex-col items-center justify-center text-[var(--color-dark-green-half)]">
                <button
                    ...
                    className="mb-5 inline-flex items-center gap-2 rounded-full bg-[var(--color-green)] px-5 py-2 text-sm font-semibold text-[var(--color-white)] shadow-md shadow-[var(--color-dark-green-octa)] hover:scale-[1.02] hover:shadow-lg active:scale-95 transition-transform duration-150"
                >
                    🎾 Play mini game &amp; win a coupon
                </button>

                <p className="mb-1 text-base font-semibold">No coupons yet</p>
                <p className="max-w-md text-center text-sm text-[var(--color-dark-green-half)]">
                    ...
                    {coupons.map((coupon) => {
                        ...
                        return (
                            <div
                                key={coupon.id}
                                className={`
                                    relative overflow-hidden rounded-2xl border bg-[var(--color-white)] 
                                    shadow-sm transition-all duration-200 cursor-pointer
                                    ${
                                        isUsed
                                            ? "border-[var(--color-dark-green-octa)] opacity-80"
                                            : "border-[var(--color-light-green)] hover:-translate-y-1 hover:shadow-md"
                                    }
                                `}
                            >
                                ...
                                <div className="pointer-events-none absolute left-0 top-1/2 -translate-x-1/2 -translate-y-1/2">
                                    <div className="h-5 w-5 rounded-full bg-[var(--color-lighter-green)] border border-[var(--color-light-green)]" />
                                </div>
                                ...
                                <div className="relative z-10 flex items-center justify-between px-3 pt-3">
                                    <span className="rounded-full bg-[var(--color-lighter-green)] px-2 py-0.5 text-[10px] font-semibold uppercase tracking-[0.16em] text-[var(--color-dark-green-half)]">
                                        Coupon
                                    </span>
                                    ...
                                    <span
                                        className={`
                                            ...
                                            ${
                                                isUsed
                                                    ? "bg-[var(--color-dark-green-octa)] text-[var(--color-dark-green-half)]"
                                                    : "bg-[var(--color-light-green)] text-[var(--color-dark-green)]"
                                            }
                                        `}
                                    >
                                        {isUsed ? "Used" : "Active"}
                                ...
                                <div className="relative z-10 px-3 pb-3 pt-1">
                                    ...
                                    <div className="mt-2 border-t border-dashed border-[var(--color-light-green)]" />

                                    <div className="mt-3 flex flex-col gap-2">
                                        <div>
                                            <div className="text-[10px] uppercase tracking-[0.16em] text-[var(--color-dark-green-half)]">
                                                Coupon code
                                            </div>
                                            <div className="mt-1 font-mono text-xl tracking-[0.3em] text-[var(--color-dark-green)]">
                                                {coupon.code}
                                            </div>
                                        </div>

                                        {coupon.expiresAt && (
                                            <div className="mt-1 text-[10px] uppercase tracking-[0.12em] text-[var(--color-dark-green-half)]">
                                                Expires:&nbsp;
